            ...
            <div class="main_company">
              <div class="main_company_top">
                <ul>
                  ...
                  <Link to="/company/9" class="company_link">
                    <li>
                      <div class="company_name_top">
              ...
              <div class="main_company_bottom">
                <ul>
                  ...
                  <Link to="/company/10" class="company_link">
                    <li>
                      <div class="company_name_top">
                        <img src="https://cdn.printgo.vn/uploads/file-logo/1/512x512.6cb97c9d25a3455adb806e42b8cbcd0f.ai.1.png"></img>
            ...
            <div class="footer_search">
              <div class="footer_search_skill">
                ...
                <ul style={{textAlign:"center"}}>
                  <li><Link to="/job-list-follow-type/1"  style={{ textDecoration: "none", color: "white"}}><div style={{fontSize:"15px"}}>Tester</div></Link></li>
                  <li><Link to="/job-list-follow-type/2"  style={{ textDecoration: "none", color: "white" }}><div style={{fontSize:"15px"}}>JavaScript</div></Link></li>
                  <li><Link to="/job-list-follow-type/3"  style={{ textDecoration: "none", color: "white" }}><div style={{fontSize:"15px"}}>C/C++</div></Link></li>
                  <li><Link to="/job-list-follow-type/5"  style={{ textDecoration: "none", color: "white" }}><div style={{fontSize:"15px"}}>.NET</div></Link></li>
                  <li><Link to="/job-list-follow-type/6"  style={{ textDecoration: "none", color: "white" }}><div style={{fontSize:"15px"}}>PHP</div></Link></li>
                  <li><Link to="/job-list-follow-type/4"  style={{ textDecoration: "none", color: "white" }}><div style={{fontSize:"15px"}}>Java</div></Link></li>
              ...
              <div class="footer_search_position">
                ...
                <ul style={{textAlign:"center"}}>
                  <li><Link to="/job-positive/1" className='text-link' style={{ textDecoration: "none", color: "white" }}><div style={{fontSize:"15px"}}>Internship</div></Link></li>
                  <li><a>Fresher</a></li>
                  <li><a>Junior</a></li>
                  <li><a>Leader</a></li>
                  <li><a>Senior</a></li>
